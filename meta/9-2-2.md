...
# Nationale Metadaten    
national_indicators_available: "<ul style='padding-left: 25px;'><li>Erwerbstätige im Verarbeitenden Gewerbe (Daten der Volkswirtschaftlichen Gesamtrechnungen)</li> <li> Beschäftigte im Verarbeitenden Gewerbe (Daten der Arbeitskräfteerhebung)</li></ul>"    
...
source_url_text_2: 'AKE: Beschäftigung - Eurostat Tabelle [lfsa_egam2]'
...
data_start_values: 
  - field: timeseries
    value: manufacturing persons employed (data from national accounts)
  - field: timeseries
    value: manufacturing persons employed (data from labor force survey)    
computation_units: "Prozent"    
copyright: '&copy; Statistisches Bundesamt (Destatis), 2023'    
data_footnotes: 'Daten der Volkswirtschaftlichen Gesamtrechnungen: 2019 bis 2022 vorläufige Daten.<br>• Daten der Arbeitskräfteerhebung: Die Ergebnisse ab 2020 sind nur eingeschränkt mit den Vorjahren vergleichbar. Weiterführende Informationen siehe "3. Data description" in den nationalen Metadaten.'    
