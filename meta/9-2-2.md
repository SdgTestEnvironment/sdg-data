...
# Nationale Metadaten    
national_indicators_available: "<ul style='padding-left: 25px;'><li>Erwerbstätige im Verarbeitenden Gewerbe (Daten der VGR des Statistischen Bundesamtes)</li> <li> Erwerbstätige im Verarbeitenden Gewerbe (Daten der AKE des Statistischen Bundesamtes)</li></ul>"    
...
data_start_values: 
  - field: timeseries
    value: manufacturing persons employed (data from na from federal statistical office)
  - field: timeseries
    value: manufacturing persons employed (data from lfs from federal statistical office)    
