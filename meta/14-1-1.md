...
footer_fields:
  - series: plastic waste on the beaches of the german north sea coast
    ...
    label: Anmerkung
    value: 'Gleitendes Dreijahresfenster: Die Werte setzen sich zusammen aus den Werten des jeweiligen Berichtsjahres und den zwei vorangegangenen Jahren.'
  - series: plastic particles in fulmar stomachs
    unit: percentage
    label: Anmerkung
    value: 'Gleitender Fünfjahresdurchschnitt: Die Werte setzen sich zusammen aus den Werten des jeweiligen Berichtsjahres und den vier vorangegangenen Jahren.'    
