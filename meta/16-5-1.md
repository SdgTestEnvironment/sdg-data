...
goal_meta_national_link_De: https://SdgTestEnvironment.github.io/sdg-indicators/public/MetaDe/16.5.1.pdf
...
source_organisation_2: <a href="https://www.bka.de" target="_blank" title="Klicken Sie hier um zur Website der Organisation Bundeskriminalamt (BKA) zu gelangen."> Bundeskriminalamt (BKA) </a>
source_organisation_logo_2: <a href="https://www.bka.de" target="_blank"><img src="https://SdgTestEnvironment.github.io/sdg-indicators/public/OrgImgDe/bka.png" alt="Logo bka" style="height:80px; width:auto; max-width:100%; object-fit:contain; border:transparent"/></a>
...
footer_fields:
  ...
  - series: private persons (donors) suspected in the context of corruption offences
    unit: number
    label: Anmerkung
    value: Die Daten beziehen sich auf tatverdächtige Gebende mit privaten Anliegen bei Korruptionsstraftaten. Erfasst werden auch jene Gebende, deren Bestechungsversuch von der Zielperson abgelehnt wurde.    
