...
footer_fields:
  - unit: percentage
    label: Anmerkungen
    value: '<br>• Frauenanteil im Deutschen Bundestag und Bundesrat: Stichtag 1. Januar<br>• Frauenanteil in den Landtagen: Wahlergebnis<br>• Frauenanteil in Kreistagen und Stadträten von kreisfreien Städten: Wahlergebnis, 2019 bis 2021 ohne Schleswig-Holstein.<br>• Frauenanteil im Deutschen Bundestag und Bundesrat: Stichtag 1. Januar<br>• Frauenanteil in den Landtagen: Wahlergebnis<br>• Frauenanteil in Kreistagen und Stadträten von kreisfreien Städten: Wahlergebnis, 2019 bis 2021 ohne Schleswig-Holstein.'
  - unit: number
    label: Anmerkungen
    value: '<br>• Frauenanteil im Deutschen Bundestag und Bundesrat: Stichtag 1. Januar<br>• Frauenanteil in den Landtagen: Wahlergebnis<br>• Frauenanteil in Kreistagen und Stadträten von kreisfreien Städten: Wahlergebnis, 2019 bis 2021 ohne Schleswig-Holstein.<br>• Stichtag 1. Januar'    
...
graph_titles:
  ...
  - unit: number
    title: Anzahl Mitglieder im Deutschen Bundestag und dem Bundesrat
graph_subtitle:     
graph_type: bar
graph_stepsize: 
  - unit: percentage
