...
source_url_text_1: OECD – Gesamtströme nach Geber (nicht auf Deutsch verfügbar)
source_url_1b: https://data-explorer.oecd.org/vis?df[ds]=DisseminateFinalDMZ&df[id]=DSD_DAC2%40DF_DAC2A&df[ag]=OECD.DCD.FSD&dq=DEU.LDC.106%2B206.USD.V&to[TIME_PERIOD]=false&vw=tb&pd=2010%2C
source_url_text_1b: OECD – Hilfszahlungen (ODA) an Länder und Regionen (nicht auf Deutsch verfügbar)
