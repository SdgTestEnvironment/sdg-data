...
footer_fields:
  ...
  - series: dalys due to long-term exposure to fine particulate matter (pm2.5) in the population aged 25 years and older
    unit: dalys
    label: Anmerkungen
    value: '<br>• Die senkrechten grauen Linien im Diagramm kennzeichnen das Konfidenzintervall der dargestellten Daten.<br>• Disability-Adjusted Life Years (DALYs): Anzahl der krankheitsspezifisch durch Mortalität und Morbidität verlorenen Lebensjahre infolge einer Feinstaub-Langzeit-Exposition (PM₂,₅).'
