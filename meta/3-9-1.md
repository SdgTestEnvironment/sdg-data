...
data_footnotes: '<br>Anzahl vorzeitiger Todesfälle (Attributable Todesfälle): Anzahl der vor Erreichen der statistisch durchschnittlichen Lebenserwartung eingetretenen Todesfälle.<br>Kardiopulmonal: das Herz und die Lunge betreffend. <br>Feinstaub Kurzzeitexposition: Mortalität aufgrund akuter Atemwegserkrankungen (Kinder < 5 Jahre): Anzahl < 1.'    
