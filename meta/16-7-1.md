...
# Nationale Metadaten    
national_indicators_available: "<ul style='padding-left: 25px;'><li>Frauenanteil der Bevölkerung im erwerbsfähigen Alter</li> <li> Frauenanteil im Deutschen Bundestag</li> <li> Frauenanteil im Bundesrat</li> <li> Frauenanteil im öffentlichen Dienst</li> <li> Frauenanteil in der Justiz</li> <li> Verhältnis von Frauen im Deutschen Bundestag</li> <li> Verhältnis von Frauen im Bundesrat</li> <li> Verhältnis von Frauen im öffentlichen Dienst</li> <li> Verhältnis von Frauen in der Justiz</li></ul>"    
...
data_start_values: 
  ...
  - field: timeseries
    value: proportion of women in the public service
  - field: timeseries
    value: proportion of women in the judiciary
  - field: timeseries
    value: ratio of women in the german bundestag (lower chamber)
  - field: timeseries
    value: ratio of women in the bundesrat (upper chamber)
  - field: timeseries
    value: ratio of women in the public service
  - field: timeseries
    value: ratio of women in the judiciary    
