...
source_url_text_1b: Interne Ausgaben und Personal für Forschung und Entwicklung (only available in German) – GENESIS online 21821-0002
...
source_organisation_logo_3: <a href=""><img src="https://g205sdgs.github.io/sdg-indicators/public/OrgImgEn/vgrdl.png" alt="Logo vgrdl" style="height:60px; width:148px"/></a>
...
data_footnote: 'R&E = Research and development. Business enterprise sector: survey by state only in odd-numbered years, in even-numbered years the breakdown by state is based on the percentage of the respective previous year.'    
