...
source_url_text_1c: Gross domestic product (GDP) (only available in German)
source_url_text_1d: Occurrence and use in raw material equivalents (only available in German)
