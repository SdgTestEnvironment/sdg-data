...
data_footnotes: 'Nursing and midwifery personnel: 2017 revised data.<br>• Total: Data are only available from 2012 due to methodological changes.<br>• 2010 partly revised data.<br>• For 2010, the population was calculated backwards using the 2011 census and migration, birth and death statistics.'    
