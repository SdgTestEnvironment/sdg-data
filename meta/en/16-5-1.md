...
source_url_text_1: Federal Situation Report on Corruption (only available in German)
...
data_footnote: The data are based on a special evaluation of the Life Situation Survey and are not publicly available.    
