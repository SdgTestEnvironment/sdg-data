...
data_footnotes: 'Population who had the impression that public officials are corruptible during their interactions with public agencies in the previous two years: The data is based on a special evaluation and is not publicly available. Data is only available from 2015.<br>• Private persons (donors) suspected in the context of corruption offences: Data is only available until 2015.'    
