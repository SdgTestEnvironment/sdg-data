...
data_footnotes: 'The data are based on a special evaluation of the Life Situation Survey and are not publicly available.<br>• Population who had the impression that public officials are corruptible during their interactions with public agencies in the previous two years: Data are only available from 2015.'    

# Grafik Eigenschaften    
graph_titles:
  - series: population who had the impression that public officials are corruptible
    title: Impression of the population on corruption in the public service
