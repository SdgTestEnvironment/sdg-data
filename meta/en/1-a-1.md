...
# Nationale Metadaten    
national_indicator_available: ODA (commitments) for poverty reduction<br>ODA (gross disbursements) for poverty reduction    
...
source_url_text_1: OECD - Data to Official development assistance (ODA)
...
graph_title: ODA for poverty reduction    
