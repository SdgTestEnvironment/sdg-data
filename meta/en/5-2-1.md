...
footer_fields:
  ...
  - unit: per 100,000 female inhabitants
    label: Notes
    value: '<br>• Number of victims per 100,000 inhabitants (V/100,000): Number of victims per 100,000 inhabitants, based on the population on 31 December of the previous year. Own calculation based on the 2022 census.<br>• The data is based on a special evaluation and is not publicly <br>• available.<br>• For victims recorded in the reporting year, the year in which the offence was committed may also be prior to the reporting year (initial statistics). Persons who were recorded as victims multiple times in the reporting year are counted multiple times accordingly.<br>• Due to methodological changes, data is only available from 2018 onwards. For further information, see ‘3. Description of the data’ in the national metadata.'
  - unit: percentage
    label: Notes
