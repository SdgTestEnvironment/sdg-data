...
footer_fields:
  - series: domestic material consumption (dmc)
    unit: million tonnes
    label: Notes
    value: '<br>• GDP: Gross domestic product.<br>• DMC: Domestic Material Consumption.<br>• Domestic material consumption per real GDP: 2020 to 2021 revised data.'
  - series: domestic material consumption (dmc)
    unit: tonnes per capita
    label: Notes
    value: '<br>• GDP: Gross domestic product.<br>• DMC: Domestic Material Consumption.<br>• Domestic material consumption per real GDP: 2020 to 2021 revised data.<br>• For 2010, the population was calculated backwards using the 2011 census and migration, birth and death statistics.'
