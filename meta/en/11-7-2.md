...
# Nationale Metadaten    
national_indicators_available: "<ul style='padding-left: 25px;'><li>Victims of sexual harassment</li> <li> Victims of physical harassment</li></ul>"    
...
data_footnote: 'The results from 2017 onwards are only comparable with previous years to a limited extent. For more information see "1. General information on the time series" in the national metadata.'    
