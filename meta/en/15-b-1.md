...
# Nationale Metadaten    
national_indicators_available: "<ul style='padding-left: 25px;'><li>ODA (commitments) for biodiversity</li> <li> ODA (gross disbursements) to the forestry sector</li></ul>"    
...
computation_units_plural: Million USD, constant prices (2018); Million USD, constant prices (2019)    
