...
comparison_sdg: 'The time series "ODA (gross disbursements) for biodiversity" is compliant with the global metadata. The time series "ODA (commitments) for biodiversity" and "ODA (gross disbursements) to the forestry sector" provides additional information.'    
