...
data_footnotes: 'Forest area located within protected areas: The data are based on a special evaluation and are not publicly available.<br>• Forest area net change rate: Data are only available from 2011 due to methodological changes.'    
