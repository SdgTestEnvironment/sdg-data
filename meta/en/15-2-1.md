...
data_footnotes: 'Forest area located within protected areas: The data are based on a special evaluation and are not publicly available. <br>• Forest area net change rate: Due to methodological changes, the results from 2016 onwards are only comparable with previous years to a limited extend.'    
