...
# Nationale Metadaten    
national_indicators_available: "<ul style='padding-left: 25px;'><li>Carbon balance for the forest ecosystem above ground</li> <li> Forest area located within protected areas</li> <li> Forest area net change rate</li> <li> Forest area under an independently verified forest management certification scheme</li></ul>"    
...
computation_units_plural: Million tonnes; Percentage    
copyright: '&copy; Federal Statistical Office (Destatis), 2021'    
data_footnotes: 'Forest area located within protected areas: The data are based on a special evaluation and are not publicly available.<br>• Forest area net change rate: Data are only available from 2011 due to methodological changes.<br>• Forest area net change rate: Classification: Until 2015, the nomenclature of the automated 	real estate bok (ALB) was valid; from 2016, the ALKIS (Official Land 	Registry Information Systm) usage catalogue.'    
