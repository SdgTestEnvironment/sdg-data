...
footer_fields:
  - series: national legislation and policy relevant to ias
    label: Notes
    value: '<br>• 1 = Yes; 0 = No und . = Unknown<br>• NBSAP: National Biodiversity Strategy and Action Plan.<br>• IAS: Invasive Alien Species.<br>• Information on the relevant legislation can be found under the "Further information" tab.'
  - series: align the nbsap targets with aichi target 9 of the strategic plan for biodiversity
    label: Notes
    value: '<br>• 1 = Yes; 0 = No und . = Unknown<br>• NBSAP: National Biodiversity Strategy and Action Plan.<br>• IAS: Invasive Alien Species.'    
