...
source_url_text_1: Gross hourly earnings, gender pay gap – GENESIS online 62111-0004
...
source_url_text_1c: Unadjusted Gender Pay Gap (GPG)
...
footer_fields:
  - series: gender pay gap
    unit: percentage
    label: Note
    value: Due to methodological changes, the results from [year] onwards are only comparable with previous years to a limited extend.    
