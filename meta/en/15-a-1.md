...
comparison_sdg: 'The time series "ODA (gross disbursements) for biodiversity" is compliant with the global metadata. The time series "ODA (commitments) for biodiversity" and "Environmental protection expenditure" provides additional information.'    
