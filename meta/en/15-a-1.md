...
# Nationale Metadaten    
national_indicators_available: "<ul style='padding-left: 25px;'><li>ODA (commitments) for biodiversity</li> <li> ODA (disbursements) for biodiversity</li> <li> Environmental protection expenditure</li></ul>"    
