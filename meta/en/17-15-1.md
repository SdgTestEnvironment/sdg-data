...
# Datenquellen
source_organisation_1: <a href=""> Global Partnership for Effective Development Co-operation </a>
source_organisation_logo_1: <a href=""><img src="https://g205sdgs.github.io/sdg-indicators/public/OrgImgEn/global.png" alt="Logo global" style="height:60px; width:148px"/></a>
...
source_url_text_1b: "Development partners' use of country-led results frameworks - Indicator results drawn from country-led results frameworks:"
source_url_1c: http://dashboard.effectivecooperation.org/viewer
source_url_text_1c: "Development partners' use of country-led results frameworks - Indicator results monitored using the partner country's own sources and monitoring systems"
