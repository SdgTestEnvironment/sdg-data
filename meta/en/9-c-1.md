...
data_footnotes: '3G: Data is only available until 2021. 3G network was deaktivated in 2021.<br>• 5G: Data is only available from 2021.<br>• Due to methodological changes, the results from 2022 onwards are only comparable with previous years to a limited extend.<br>• Länder: Data is only available from 2021.'    
