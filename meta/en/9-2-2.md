...
data_footnotes: 'Data from national accounts (NA): 2021 to 2023 provisional data.<br>• Data from labor force survey (LFS): The results from 2020 onwards are only comparable with previous years to a limited extent. For more information see "3. Data description" in the national metadata.'    
