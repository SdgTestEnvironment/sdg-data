...
# Nationale Metadaten    
national_indicators_available: "<ul style='padding-left: 25px;'><li>Manufacturing persons employed (Data from National Accounts)</li> <li> Manufacturing persons employed (Data from labor force survey)</li></ul>"    
...
source_url_text_2: 'LFS: Employment - Eurostat table [lfsa_egam2]'
    
computation_units: "Percentage"    
copyright: '&copy; Federal Statistical Office (Destatis), 2023'    
data_footnotes: 'Data from national accounts: 2019 to 2022 preliminary data.<br>• Data from labor force survey: The results from 2020 onwards are only comparable with previous years to a limited extent. For more information see "3. Data description" in the national metadata.'    
