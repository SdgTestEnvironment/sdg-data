...
# Nationale Metadaten    
national_indicators_available: "<ul style='padding-left: 25px;'><li>Manufacturing persons employed (data from NA from Federal Statistical Office)</li> <li> Manufacturing persons employed (data from LFS from Federal Statistical Office)</li></ul>"    
