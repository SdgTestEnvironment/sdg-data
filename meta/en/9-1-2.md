...
footer_fields:
  - series: passenger transport
    ...
    label: Notes
    value: <br>• 2020 partly revised data.<br>• The data is based on a special evaluation and is not publicly available. <br>• 2020 partly preliminary data.
  - series: freight transport
    unit: million tonne-kilometres
    label: Notes
    value: '<br>• 2020 partly revised data.<br>• Rail transport: Due to methodological changes, the results from 2016 onwards are only comparable with previous years to a limited extend.<br>• Road transport: 2021 preliminary data.'    
