...
data_footnotes: 'Partly revised data.<br>• Freight transport, rail transport: Aufgrund methodischer Änderungen sind die Ergebnisse ab 2016 nur eingeschränkt mit den Vorjahren vergleichbar.<br>• Passenger transport: The data is based on a special evaluation and is not publicly available. 2020 partly preliminary data.'    
