...
footer_fields:
  ...
  - series: freight transport
    ...
    label: Notes
    value: '<br>• Partly revised data.<br>• Rail transport: Due to methodological changes, the results from 2016 onwards are only comparable with previous years to a limited extend.<br>• Road transport: 2021 preliminary data.'    
