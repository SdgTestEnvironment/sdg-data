...
# Nationale Metadaten    
national_indicators_available: "<ul style='padding-left: 25px;'><li>Manufacturing gross value added</li> <li> Manufacturing gross value added per capita</li> <li> Manufacturing gross value added as a proportion of GDP</li> <li> Manufacturing gross value added as a proportion of total gross value added</li></ul>"    
...
computation_units: EUR; Percentage    
copyright: '&copy; Federal Statistical Office (Destatis), 2022'    
footer_fields:
  - series: manufacturing gross value added
    unit: "%"
    label: Note
    value: 2018 to 2021 preliminary data.
  - series: manufacturing gross value added
    unit: eur
    label: Note
    value: 2018 to 2021 preliminary data.
  - series: manufacturing gross value added per capita
    unit: eur
    label: Notes
    value: <br>• 2018 to 2021 preliminary data.<br>• For 2010, the population was calculated backwards using the 2011 census and migration, birth and death statistics.
