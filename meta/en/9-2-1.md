...
footer_fields:
  - series: manufacturing gross value added
    unit: percentage
    label: Note
    value: 2019 to 2022 provisional data.
  - series: manufacturing gross value added
    unit: eur
    label: Note
    value: 2019 to 2022 provisional data.
  - series: manufacturing gross value added per capita
    unit: eur
    label: Notes
    value: <br>• 2019 to 2022 provisional data.<br>• For 2010, the population was calculated backwards using the 2011 census and migration, birth and death statistics.
