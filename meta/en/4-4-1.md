...
source_url_text_2b: "Individuals' level of computer skills (2021 onward) - Eurostat table [isoc_sk_cskl_i21]"
    
computation_units: "Percentage"    
copyright: '&copy; Federal Statistical Office (Destatis), 2022'    
data_footnote: From 2021 onwards, the survey on the use of information and communication technologies in private households (ICT) is integrated into the microcensus as a sub-sample. Due to the associated methodological changes, a comparison of the results for the survey year 2021 with previous years is possible only to a very limited extent (time series break).    
