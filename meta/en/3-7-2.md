...
data_footnotes: The age of the mothers is determined using the age-year method. <br>• The data are based on a special evaluation and are not publicly available.<br>• For 2010, the population was calculated backwards using the 2011 census and migration, birth and death statistics.    
