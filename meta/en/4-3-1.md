...
data_footnotes: 'The data are based on a special evaluation and are not publicly available.<br>• The results from 2020 onwards are only comparable with previous years to a limited extent. For more information, see the national metadata under "3. Data description".'    
