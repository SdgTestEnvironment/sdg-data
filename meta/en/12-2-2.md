...
footer_fields:
  - series: domestic material consumption (dmc)
    ...
    label: Notes
    value: '<br>• Domestic material consumption per real GDP: 2020 to 2021 partly revised data.<br>• For 2010, the population was calculated backwards using the 2011 census and migration, birth and death statistics.'
  - series: domestic material consumption (dmc)
    unit: million tonnes
    label: Note
    value: 'Domestic material consumption per real GDP: 2020 to 2021 partly revised data.'
