...
# Nationale Metadaten    
national_indicators_available: "<ul style='padding-left: 25px;'><li>CO<sub>2</sub> emissions per real GDP</li> <li> CO<sub>2</sub> emissions per gross value added (price adjusted) in manufacturing industries</li></ul>"    
...
graph_title: CO<sub>2</sub> emission per unit of value added    
