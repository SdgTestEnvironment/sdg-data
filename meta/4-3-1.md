...
data_footnotes: Die Daten basieren auf einer Sonderauswertung und sind nicht öffentlich zugänglich.<br>• Durch eine Umstrukturierung des Mikrozensus sind die Daten 2020 nur eingeschränkt mit den Daten der Vorjahre vergleichbar.    
...
graph_annotations:
  - value: 9.5
    description: Methodological Changes from 2019 to 2020
    mode: vertical
    borderColor: '#949494'
    borderDash: [2, 2]
    label:
    - position: top
      content: Methodische Änderung
