...
# Nationale Metadaten    
national_indicator_available: Subventionen für fossile Brennstoffe    
...
footer_fields:
  - unit: million eur
    label: Anmerkungen
    value: '<br>• Direkte finanzielle Beihilfen (direkte Subventionen): Unmittelbare Geldzahlungen des Staates, beispielsweise in Form von Zuschüssen für Unternehmen, Investitionshilfen, Förderprogrammen in der Energie- oder Industriepolitik sowie Ausgleichszahlungen.<br>• Steuervergünstigungen (indirekte Subventionen): Staatlich entgangene Einnahmen durch steuerliche Entlastungen, etwa reduzierte Energiesteuersätze, Steuerbefreiungen für bestimmte Branchen oder Sonderabschreibungen.<br>• Daten sind erst ab 2015 verfügbar.'
  - unit: percentage of gdp
    label: Anmerkungen
    value: '<br>• Direkte finanzielle Beihilfen (direkte Subventionen): Unmittelbare Geldzahlungen des Staates, beispielsweise in Form von Zuschüssen für Unternehmen, Investitionshilfen, Förderprogrammen in der Energie- oder Industriepolitik sowie Ausgleichszahlungen.<br>• Steuervergünstigungen (indirekte Subventionen): Staatlich entgangene Einnahmen durch steuerliche Entlastungen, etwa reduzierte Energiesteuersätze, Steuerbefreiungen für bestimmte Branchen oder Sonderabschreibungen.<br>• Daten sind erst ab 2015 verfügbar.<br>• BIP: Bruttoinlandsprodukt.'    

# Grafik Eigenschaften    
graph_title: Subventionen für fossile Brennstoffe
graph_subtitle:     
graph_type: line
graph_stepsize: 
  - unit: percentage of gdp
