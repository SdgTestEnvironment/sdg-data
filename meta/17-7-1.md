...
# Nationale Metadaten    
national_indicators_available: "<ul style='padding-left: 25px;'><li>Gesamter Produktionswert des Sektors Umweltgüter und Umweltdienstleistungen (EGSS)</li> <li> Bruttoanlageinvestitionen für Umweltschutz</li></ul>"    
comparison_sdg: 'Die Zeitreihe "Gesamter Produktionswert des Sektors Umweltgüter und -dienstleistungen (EGSS)" entspricht den UN-Metadaten.<br>Die Zeitreihe "Bruttoanlageinvestitionen für Umweltschutz" entspricht teilweise den UN-Metadaten.'    
...
graph_titles:
  - series: total production value of the environmental goods and services sector (egss)
    title: Gesamter Produktionswert des Sektors Umweltgüter und Umweltdienstleistungen (EGSS)
