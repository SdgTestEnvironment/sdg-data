...
footer_fields:
  ...
  - unit: per 100,000 female inhabitants
    label: Anmerkungen
    value: '<br>• Opfergefährdungszahl: Anzahl der Opfer je 100&nbsp;000 Einwohnerinnen, bezogen auf die Stichtagsbevölkerung zum 31. Dezember des Vorjahres. Eigene Berechnung auf Basis Zensus 2022.<br>• Die Daten basieren auf einer Sonderauswertung und sind nicht öffentlich zugänglich.<br>• Bei den im Berichtsjahr erfassten Opfern kann das Tatjahr auch vor dem Berichtsjahr liegen (Ausgangsstatistik). Personen, die im Berichtsjahr mehrfach als Opfer erfasst wurden, werden entsprechend mehrfach gezählt.<br>• Aufgrund methodischer Änderungen sind Daten erst ab 2018 verfügbar. Weiterführende Informationen siehe "3. Beschreibung der Daten" in den nationalen Metadaten.'
  - unit: percentage
    label: Anmerkungen
    value: '<br>• Für die Berechnung wird die zurückgerechnete Durchschnittsbevölkerung verwendet. Diese wurde für das Berichtsjahr 2010 auf Basis des Zensus 2011 sowie der Wanderungs-, Geburten- und Sterbestatistiken ermittelt und für die Berichtsjahre 2012 bis 2021 analog auf Basis des Zensus 2022 berechnet.<br>• Die Daten basieren auf einer Sonderauswertung und sind nicht öffentlich zugänglich.<br>• Bei den im Berichtsjahr erfassten Opfern kann das Tatjahr auch vor dem Berichtsjahr liegen (Ausgangsstatistik). Personen, die im Berichtsjahr mehrfach als Opfer erfasst wurden, werden entsprechend mehrfach gezählt.<br>• Aufgrund methodischer Änderungen sind Daten erst ab 2018 verfügbar. Weiterführende Informationen siehe "3. Beschreibung der Daten" in den nationalen Metadaten.'    
